...
[xxx,prv,k]=retelimine([x,xx],5000*eps);x=xxx(k(1:mx));xx=xxx(k(mx+1:end));% pour eviter les doublons
[yyy,prv,k]=retelimine([y,yy],5000*eps);y=yyy(k(1:my));yy=yyy(k(my+1:end));
